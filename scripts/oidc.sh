...
GITHUB_REPO="bilan-azure-backend"
BRANCH="main"
...
az identity federated-credential create \
  ...
  --subject "repo:MalikCherfi@90403152/${GITHUB_REPO}@1317063503:ref:refs/heads/main" \
...
az identity federated-credential create \
  ...
  --resource-group "$RG" \
  --issuer "https://token.actions.githubusercontent.com" \
  --subject "repo:MalikCherfi@90403152/${GITHUB_REPO}@1317063503:pull_request" \
  --audiences "api://AzureADTokenExchange"
